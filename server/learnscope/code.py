...
template = '''Answer the current question in detail. You may use the context to enhance your response, but do not rely solely on it. Ensure that if the question is about laws and regulations, your answers are based exclusively on INDIAN laws and regulations.

Formatting instructions:
- Use '**' for bold text (e.g., **bold text**)
...
Respond with only the answer, following the specified format, and do not add anything else.
'''


template2 = '''Summarize the content below, including key points and any relevant additional details. 

Please follow this structure:
- Bold text should be wrapped in ** (e.g., **bold text**)
- Each Bullet points should be marked with a '✮' 
- Use '\\n' at each new line

Provide only the summary using this structure.
