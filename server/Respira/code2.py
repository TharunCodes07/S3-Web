...
def convo_template(llm):
    ...
    '''
    prompt2 = PromptTemplate(input_variables=['prediction'], template=template2)
    ...
    conversation2 = LLMChain(llm=llm, prompt=prompt2, verbose=False)
    return conversation , conversation2

# Initialize the LLM
llm = ChatGroq(
            groq_api_key='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',
            model_name='llama-3.1-70b-versatile')
chat, chat2 = convo_template(llm)
